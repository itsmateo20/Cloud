# NEW VERSION COMING SOON - [PROGRESS](https://github.com/ItsMateo20/Cloud/tree/new)
- NEW DESIGN
- OLD FUNCTIONS
- NEW FUNCTIONS
...
[![Last commit](https://img.shields.io/github/last-commit/itsmateo20/Cloud/main?style=for-the-badge&labelColor=white&color=gray)](https://github.com/ItsMateo20/Cloud/commit/main)
...
This project was created for fun but will be used by me to store my files, eliminating the need for services like Google Photos or other web cloud storage solutions. The main project was completed in just 2-3 weeks but is still being updated with new features and security enhancements.

You can preview what this project can do on the [Github page](https://itsmateo20.github.io/Cloud), for a move advanced view there is a bit of information lower down [here](#Features) or [here](https://itsmateo20.gitbook.io/cloud/overview/features)
...
---
- **Q: Is there some guide on how to setup this application?..**
- A: Yes you can check it out on our [gitbook guide](https://itsmateo20.gitbook.io/cloud/fundamentals/getting-set-up)
---
- **Q: How do I migrate/update to newer versions of this application?..**
- A: To migrate to newer versions of this application follow the gitbook guide [here](https://itsmateo20.gitbook.io/cloud/guides/server/migrating)
</details>
...
All the free icons assets I have used can be found [here](./Attributions.md) or [here](https://itsmateo20.gitbook.io/cloud/overview/attributions)
