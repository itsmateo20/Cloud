...
export function shouldForceDownload(filename) {
    ...
    const rawExtensions = ['nef', 'cr2', 'arw', 'dng', 'raf', 'rw2', 'orf', 'srw', 'pef', 'x3f', '3fr', 'erf', 'sr2', 'kdc', 'mef', 'mos', 'bay', 'rwl', 'raw'];
    return executableExtensions.includes(ext) || rawExtensions.includes(ext);
}
